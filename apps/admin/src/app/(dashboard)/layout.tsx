...
const MAIN_NAV = [
  ...
  { href: '/queue',      label: '候位管理', icon: Icon.list       },
  { href: '/coupons',    label: '優惠券',   icon: Icon.ticket     },
  { href: '/forms',      label: '問卷表單', icon: Icon.clipboard  },
  { href: '/orders',     label: '點餐管理', icon: Icon.shoppingBag},
  { href: '/draw',       label: '抽獎活動', icon: Icon.sparkles   },
];

const SETTINGS_NAV = [
  { href: '/settings/line',     label: 'LINE 串接', icon: Icon.link    },
    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-brand">
          <div className="brand-icon">{Icon.hub}</div>
          <div>
            <div className="brand-name">LINE Hub</div>
            <div className="brand-sub">商家管理後台</div>
          </div>
        </div>
